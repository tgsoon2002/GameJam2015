...
public class BarMovement2 : MonoBehaviour
{
	...
	private Vector3 oldGreenBarSize;
	...
	void SuccessBeam ()
	{
		...
		dotSpeed += 0.3f;
		oldGreenBarSize = greenBar.localScale;
		oldGreenBarSize.y *= 0.9f;
		greenBar.localScale = oldGreenBarSize;
	}
	...
	{
		dotSpeed = baseSpeed;
		greenBar.localScale = Vector3.one;
	}
